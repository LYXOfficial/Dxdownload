...
# Form implementation generated from reading ui file 'E:\python\pyqt\Dxdownload.ui'
#
...
try:
    class Ui_MainWindow(object):
        ...
        def retranslateUi(self, MainWindow):
            def tw():
                os.system("pythonw "+getpath()+"\\lib\\tweet.py")
            ...
            self.pushButton.clicked.connect(dl.login)
            ...
            self.treeWidget.setHeaderLabels(["文件","大小","日期","MD5"])
            ...
            self.treeWidget.setHeaderLabels(["文件","大小","作者","日期","MD5"])
            ...
            self.treeWidget_2.headerItem().setText(0, _translate("MainWindow", "文件 大小"))
